...
class Storage {
    ...
    save(data) {
        window.localStorage.setItem(this.key, JSON.stringify(data)) // takes your data and turns it into JSON to show in the browser
    }
}
...
searchBox.addEventListener('keydown', (e) => {
    const { key, target } = e; //whats this doing? 
